...
if("TRUE" STREQUAL "TRUE")
  set(ca_driver_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/create_autonomy/ca_driver)
  set(ca_driver_DEVEL_PREFIX /home/ubuntu/catkin_ws/src/create_autonomy/ca_driver/build/devel)
  ...
  set(ca_driver_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/ubuntu/catkin_ws/src/create_autonomy/ca_driver/include;/home/ubuntu/catkin_ws/devel/include;/usr/include " STREQUAL " ")
  set(ca_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/create_autonomy/ca_driver/include;/home/ubuntu/catkin_ws/devel/include;/usr/include")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ca_driver_NUM_DUMMY_TARGETS)
      set(ca_driver_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ca_driver::wrapped-linker-option${ca_driver_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ca_driver_NUM_DUMMY_TARGETS "${ca_driver_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ca_driver::wrapped-linker-option${ca_driver_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ca_driver_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/catkin_ws/src/create_autonomy/ca_driver/build/devel/lib;/home/ubuntu/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
